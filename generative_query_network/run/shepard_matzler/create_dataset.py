...
def main():
    ...
    dataset = gqn.data.Archiver(
        ...
        num_views=args.num_views_per_scene)
    ...
    while True:
        ...
        total_frames = args.num_views_per_scene
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=False)
    parser.add_argument(
        "--total-observations", "-total", type=int, default=20000)
    parser.add_argument(
        "--num-observations-per-file", "-per-file", type=int, default=1000)
    parser.add_argument("--num-views-per-scene", "-k", type=int, default=15+1)
